...
import {
  Globe, Rocket, RefreshCw, Wrench, Play, Terminal, KeyRound, Trash2, Plus, Loader2,
      ...
      <div className="mt-6">
        ...
        {tab === "environment" && (
          <EnvTextEditor
            ...
            environmentText={data.application.environmentText}
            resourceId={id}
            saveUrl={(i) => `/applications/${i}/environment`}
            revealUrl={(i, e) => `/applications/${i}/environment/${e}/reveal`}
            onSaved={() => queryClient.invalidateQueries({ queryKey: ["application-detail", id] })}
          />
        )}
