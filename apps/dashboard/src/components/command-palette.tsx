      ...
      <div className="p-3">
        ...
        <div className="mt-3 max-h-[360px] overflow-y-auto">
          {filteredActions.length > 0 && (
            <>
              <p className="px-3 pb-1.5 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">Actions</p>
          ...
          {results && (results.applications.length > 0 || results.servers.length > 0 || results.databases.length > 0) && (
            <>
              <p className="px-3 pb-1.5 pt-3 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">Resources</p>
